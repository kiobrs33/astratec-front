...
interface SensorData {
  ...
  aceleracionAngular: { x: number; y: number; z: number };
  gps: {
    latitud: number;
    longitud: number;
    velocidad: number;
...
const initialSensorData: SensorData = {
  ...
  aceleracionAngular: { x: 0, y: 0, z: 0 },
  gps: {
    latitud: 0,
    longitud: 0,
    velocidad: 0,
    ...
    <>
      <div className="dashboard" id="home">
        ...
        <div className="sensors">
          ...
          <div className="sensor sensor--angular">
            <div className="sensor__title">Aceleración Angular - X Y Z</div>
            <div className="sensor__content">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="24"
